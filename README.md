...
2. [`architecture/01-principles.md`](architecture/01-principles.md) through [`architecture/24-v0.9-decisions.md`](architecture/24-v0.9-decisions.md) — current modular architecture and decision history.
...
The current architecture baseline is **v0.9**.
