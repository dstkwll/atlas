...
The profile declares `skills: [atlas]`; its instructions and shared skill bytes remain unchanged. Setup guidance explains host-dependent preload and its limits. Detailed experiments remain in local maintainer evidence; the public [compatibility summary](../docs/validation/copilot-core-preload.md) records relevant coverage and unresolved behavior.
