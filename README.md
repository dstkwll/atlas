...
2. [`architecture/01-principles.md`](architecture/01-principles.md) through [`architecture/23-v0.8-decisions.md`](architecture/23-v0.8-decisions.md) — current modular architecture and decision history.
...
The current architecture baseline is **v0.8**.
