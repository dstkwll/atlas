...
Use when API behavior is uncertain, setup guidance may be stale, or a change affects what users and maintainers need to know. Identify the question and the actual installed/resolved library, framework or protocol version before looking up examples.
