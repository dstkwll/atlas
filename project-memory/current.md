...
Build the minimum repository-native Atlas successor lead seed. Done means a fresh lead can use only this repository to reconstruct the bounded bootstrap goal, accepted and provisional truth, authority, exact repository identity, evidence, and next safe action; resume after session loss; and stop precisely at a material authority change. The result is a reviewable draft pull request, not a migration or merge.

## Current slice

- **Status:** seed implemented; repository-only black-box proofs and fresh two-axis review passed; independent handoff acceptance and merge remain outside the lead's authority.
...
- **Reviewed candidate:** `5de7c62abde110573b7d26074559fe36f2d9d55b` on `feat/bootstrap-lead-seed`; this final evidence checkpoint follows it, so a fresh lead must still verify the branch `HEAD` and draft PR head before relying on it.
- **Draft pull request:** `https://github.com/dstkwll/atlas-successor/pull/1` (open, draft, unmerged).
- **Next safe action:** return the draft PR, exact candidate, and proof evidence to Dan/architecture for independent handoff acceptance; do not merge.
...
- Root `AGENTS.md` is the enduring lead contract; this file is the replaceable current-state front door.
- Exact prose and headings may change if the meaning remains recoverable. No deterministic state mechanism has been earned.
...
- Drive controls were refreshed before mutation. Root control modification times: `AGENTS.md` `2026-08-25T15:07:14.356Z`; root `README.md` `2026-08-25T15:07:26.672Z`; `handoffs/README.md` `2026-08-25T15:07:07.409Z`; `ToHermes/README.md` `2026-08-25T15:07:32.093Z`.
- Exact successor sources read: canonical `00` `1ZCTnWOHueqROKJcuybAuRv44HClSO0-8BWALusSBEkA` @ `2026-09-03T14:05:18.200Z`; `02` `1QiTPa_t4pSxGtCE0WMkswsL1stS6AGp5FzRUy_xiDWg` @ `08:24:41.323Z`; `03` `1MYCW_2zdiiuF-4vBcZTbf0IdKKEHkNzYlpzXyDRY5Bg` @ `08:24:51.818Z`; `04` `1jkXAT5UjPcPO1Vj5yXLAuW4wwri4csbGd8aa76mRsk4` @ `08:25:02.156Z`; `05` `1GsGBdnxXufxfSOvmdFNbR1wwaafOh5uMefCwXB_2_mY` @ `08:25:11.303Z`; `10` `1hynxDBPCVsy-Oh5XYfY12aE9OoOkLTM3FF2_2qUPw6M` @ `08:27:11.895Z`; `11` `1m3uKdX0PE3-2AGa_PD0qQ3dG9U9iTP8MdPs9zcqQ3Js` @ `14:05:04.105Z` (all `2026-09-03`).
- Exact accepted-slice sources read: `00` `1Kw6xWQtDQ7rUtECwRQyrb0mCpKLJJy1tr_cVoRsYZvM` @ `2026-09-03T18:17:36.114Z`; `01` `1MhU889JdMzjBpQXpAQ2a6KyCqoHhkR-pPoUbJgU-auc` @ `18:17:48.532Z`; `02` `1S23noV8zeUl11QdMWXFOO7qPt2ZIfHekx-CVKIbC-JI` @ `18:16:14.035Z`; active handoff `1WdrddTBARYD6X_a2kW3ai2RSKbZ_NYDmOiBC0u5xdEw` @ `18:17:01.622Z`; `ToCodex/README.md` `1n1-KaVdkUoikjajIQXhMtd99nDpqKSQK` @ `2026-08-25T15:07:37.542Z`.
...
- Initial two-axis review found an unproven “proves” statement and ambiguity around the already-authorized draft-PR publication boundary; both were corrected. Fresh Standards and Spec reviews passed the exact corrected candidate `5de7c62abde110573b7d26074559fe36f2d9d55b` with no findings, and a fresh repository-only resume/authority audit passed with no material ambiguity. No independent handoff acceptance or merge is claimed.
