...
def cross_skill_contracts(skills: Path) -> list[tuple[str, str]]:
    ...
    required = {
        ...
        "system-design-template": [
            ...
            "### Decision map", "| Decision | Selected route | Relationship / disposition | Implementation consequence |",
        ...
        "system-design-board": [
            ...
            "Decision identities are unique after normalization", "option numbers are unique within each decision",
