...
2. [`architecture/01-principles.md`](architecture/01-principles.md) through [`architecture/20-v0.5-decisions.md`](architecture/20-v0.5-decisions.md) — current modular architecture and decision history.
...
The current architecture baseline is **v0.5**.
