...
Keep donor comparisons and adaptation research in the maintainer's research notes. Retain current design rationale needed for safe maintenance in the repository and applicable third-party attribution and license notices in distributions. Product use and maintenance must not depend on private notes. Follow [the documentation boundary decision](docs/decisions/2026-09-26-documentation-boundaries.md) when placing accepted rationale and validation evidence. Keep detailed trial histories and tooling diagnostics in maintainer evidence.
