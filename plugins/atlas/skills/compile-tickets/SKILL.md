...
Compile the exact Stage 5 candidate. This is decomposition and proof planning under accepted design, not another design stage and not execution. D-084 governs vertical ticket semantics; D-085 governs execution-complete readiness and deterministic proof.
...
4. Every ticket references every applicable accepted source kind and exact existing source sections. Stage 0 has no synthetic section. Program Design touchpoints are normative expectations, not an exhaustive file allowlist.
