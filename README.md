...
2. [`architecture/01-principles.md`](architecture/01-principles.md) through [`architecture/27-v0.12-decisions.md`](architecture/27-v0.12-decisions.md) — current modular architecture and decision history.
3. [`architecture/rolling-monolith.md`](architecture/rolling-monolith.md) — portable concatenation of the complete current architecture.
...
The current architecture baseline is **v0.12**.
