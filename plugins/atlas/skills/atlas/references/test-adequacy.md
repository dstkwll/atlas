...
Distinguish feasibility evidence, usable implementation and production readiness from the artifact's intended use and accepted claim. For a disposable probe, test what makes its conclusion trustworthy. Add stress testing, resilience infrastructure or broad edge-case coverage only when it affects that question or an accepted usage requirement. Security, privacy and side-effect obligations still apply to probes. Classify review findings against the claim: adjacent improvements do not automatically become defects that block ending the investigation. Do not weaken required evidence or relabel intended production work as a probe to avoid its obligations.
