...
2. [`architecture/01-principles.md`](architecture/01-principles.md) through [`architecture/28-v0.13-decisions.md`](architecture/28-v0.13-decisions.md) — current modular architecture and decision history.
...
The current architecture baseline is **v0.13**.
