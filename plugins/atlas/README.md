...
Give your main agent a software goal. Atlas guides discovery, design, implementation, review and recovery as needed, using one skill with core activity guides and optional specialist runbooks. It needs no runtime dependencies, hooks, extra accounts or ECC installation.
