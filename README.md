...
2. [`architecture/01-principles.md`](architecture/01-principles.md) through [`architecture/19-v0.4-decisions.md`](architecture/19-v0.4-decisions.md) — current modular architecture and decision history.
...
The current architecture baseline is **v0.4**.
